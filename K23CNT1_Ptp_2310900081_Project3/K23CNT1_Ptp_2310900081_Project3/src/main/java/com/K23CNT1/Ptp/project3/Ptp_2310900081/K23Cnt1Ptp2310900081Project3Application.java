...
public class K23Cnt1Ptp2310900081Project3Application {
    ...
    public CommandLineRunner initData(
            ...
            PtpDanhMucRepository danhMucRepo,             // <-- THÊM REPO
            PtpThuongHieuRepository thuongHieuRepo,
            PtpTrangThaiDonHangRepository trangThaiRepo) {    // <-- THÊM REPO
        return args -> {
            ...
            if (nguoiDungRepo.count() == 0) {
                ...
                // Sửa lỗi UserRole nếu bạn đã định nghĩa nó trong Entity PtpNguoiDung
            ...
            if (trangThaiRepo.count() == 0) {
                ...
                trangThaiRepo.save(new PtpTrangThaiDonHang(null, "HOÀN THÀNH", "Đơn hàng đã giao thành công và hoàn tất."));
